...
// - not return anything
function checkAnswers (index,guess){
  console.log("The answers is" + answers[index]);

  if(guess === answers[index]){
    score++
    console.log("you got it correct")
  }else{
    console.log("Sorry, you got it worng")
...
function playgame(){
  ...
  let guess =askQuestions(x)
    checkAnswers(x,guess);
  }
}
